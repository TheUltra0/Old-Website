(function() {
    var sliderCanvas = document.querySelector('.pieces-slider__canvas3');
    var imagesEl = [].slice.call(document.querySelectorAll('.pieces-slider__image3'));
    var textEl = [].slice.call(document.querySelectorAll('.pieces-slider__text3'));
    ...
    var textOptions = {
        ...
        piecesWidth: function() { return Pieces.random(20, 100); },
    ...
    function initEvents() {
        document.getElementById('radio31').addEventListener('click', nextItem0);
        document.getElementById('radio32').addEventListener('click', nextItem1);
        document.getElementById('radio33').addEventListener('click', nextItem2);
        document.getElementById('radio34').addEventListener('click', nextItem3);
        document.getElementById('radio35').addEventListener('click', nextItem4);
    ...
    function resizeStart() {
        if (initial) {
            ...
            sliderCanvas.classList.add('pieces-slider__canvas3--hidden');
        }
    ...
    function resizeEnd() {
        ...
        hideTimer = setTimeout(() => {
            sliderCanvas.classList.remove('pieces-slider__canvas3--hidden');
        }, 500);
    }
})();