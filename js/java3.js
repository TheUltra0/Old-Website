...
(function() {
    ...
    function initEvents() {
        document.getElementById('radio1').addEventListener('click', nextItem0);
        document.getElementById('radio2').addEventListener('click', nextItem1);
        document.getElementById('radio3').addEventListener('click', nextItem2);
        document.getElementById('radio4').addEventListener('click', nextItem3);
        document.getElementById('radio5').addEventListener('click', nextItem4);
